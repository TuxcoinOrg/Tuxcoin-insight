...
* Update manpages, see [gen-manpages.sh](https://github.com/tuxcoin-project/tuxcoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/tuxcoin-project/tuxcoin-detached-sigs.git
...
- Detached signatures will then be committed to the [tuxcoin-detached-sigs](https://github.com/tuxcoin-project/tuxcoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the tuxcoin.org server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the tuxcoin.org server.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/tuxcoin-project/tuxcoin/releases/new) with a link to the archived release notes.
